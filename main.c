...
int main() {
    ...
    // Early warnings
    assert(batteryIsOk(2.25, 75, 0.6));       // Approaching lower temperature limit
    assert(batteryIsOk(42.75, 75, 0.6));      // Approaching higher temperature limit
    assert(batteryIsOk(20, 24, 0.6));        // Approaching discharge
    assert(batteryIsOk(20, 76, 0.6));        // Approaching charge-peak
    assert(batteryIsOk(20, 40, 0.76));      // Approaching maximum charge rate
