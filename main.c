...
int main() {
    ...
    //Early warnings
    assert(batteryIsOk(2.25, 75, 0.5));  // Approaching lower temperature limit
    assert(batteryIsOk(42.75, 75, 0.5));  // Approaching higher temperature limit
    assert(batteryIsOk(30, 24, 0.5));  // Approaching discharge
    assert(batteryIsOk(30, 76, 0.5));  // Approaching charge-peak
